...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conname = 'software_license_model_check'
    ) THEN
        ALTER TABLE software 
...
GRANT SELECT ON expiring_licenses TO authenticated;
GRANT EXECUTE ON FUNCTION get_licenses_requiring_attention() TO authenticated;