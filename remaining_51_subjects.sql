...
-- Ja hi ha 80 assignatures a la base de dades

INSERT INTO subjects (
    id, code, name, credits, year, type, degree, 
    "ID Itinerari", "Area Coord", active
) VALUES 
    ('8cbbef55-85b1-4d2f-b18c-0acae0793f3c', 'GBV14L', 'Taller de Materials Tous i Estampació', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('9b7d5566-f151-4197-92a2-5bd83f44ee2f', 'GBV01P', 'Pràctiques Crítiques en les Arts i les Ciències Socials', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ('ad8ac22b-468f-46bb-80fa-9d9bb2c4af62', 'GBV04P', 'Debats Contemporanis en les Arts i les Ciències Socials', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ('8959221b-cf36-4528-b2aa-792ab4c042e4', 'GBV05P', 'Debats Contemporanis en les Arts, les Ciències i les Tecnologies', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ...
    ('8601d9d5-f229-4764-8d24-8c4313e7a124', 'GBV00L', 'Taller de Dibuix Experimental', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('ecfb81d8-6873-4a9b-a18b-ee91e824e534', 'GBV00P', 'Pràctiques Crítiques en les Arts i les Humanitats', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ('1c6356ee-2e6b-4000-816e-4499ddeafdc8', 'GBV01L', 'Taller de Pedagogies Experimentals', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('6ec32ab2-b6a6-4338-b9e5-21f00646b974', 'GBV02L', 'Taller de Procediments Pictòrics', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('08c4f596-9756-4b6a-9925-162c450f49da', 'GBV02P', 'Pràctiques Crítiques en les Arts, les Ciències i les Tecnologies', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ('575c4532-30a7-43c4-8ae9-b97a262bf155', 'GBV03P', 'Debats Contemporanis en les Arts i les Humanitats', 6, 3, 'obligatoria', 'Belles Arts', 'PCDC', NULL, true),
    ('648b5ad5-a725-4d8f-ace8-a46d2840a738', 'GBV04L', 'Taller de Procediments Escultòrics', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('ef389a81-fc1f-4c33-a54e-fcc02e0d96ed', 'GBV06L', 'Taller de Performance i Acció', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('2a655f8b-043c-4eb1-a062-b5401497b646', 'GBV09L', 'Taller de Videoart', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('14b3c40a-b9e8-4ce2-9e7a-c7d3204c4721', 'GBV11L', 'Taller d''Interacció', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('4db9c1fc-6de2-4e49-baa5-b66145d34d31', 'GBV13L', 'Taller d''Edicions d''Artista', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('0ce84627-cdad-4802-805e-42d7f58e78e7', 'GBV03L', 'Taller de Procediments Pictòrics Experimentals', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('0efe97d8-9680-4938-9b41-362a7f663c60', 'GBV05L', 'Taller de Fabricació Digital', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
    ('c168bc06-c54a-4575-a171-c6078a5fdc8d', 'GBV08L', 'Taller d''Animació i Stop Motion', 6, 3, 'obligatoria', 'Belles Arts', 'LTTA', NULL, true),
