-- IMPORTANT: Execute this SQL in your Supabase Dashboard
-- Go to: https://supabase.com/dashboard/project/mydosupsbcehbqipimdy/editor
...
GROUP BY s.id, s.name, s.version, s.category, s.license_type, s.operating_systems, 
         s.created_at, s.updated_at, s.license_model, s.license_quantity, 
         s.license_cost, s.last_renewal_date, s.expiry_date, s.renewal_reminder_days,
         s.provider_name, s.provider_email, s.provider_phone, s.notes;
